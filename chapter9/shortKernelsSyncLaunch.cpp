/*
 * 9.4.1 {Sample#1} lots of short kernels launched synchronously 
 * Usage:
 *   1) compiling: mxcc -x maca shortKernelsSyncLaunch.cpp -o shortKernelsSyncLaunch
 *   2) running：./shortKernelsSyncLaunch
 */
#include <iostream>
#include <vector>
